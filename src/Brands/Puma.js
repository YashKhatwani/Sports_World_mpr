    ...
    <div className="home ">
      <div className="home__container">
        <div className="home__row">
          ...
          <Product
            id="12321341"
            title="Puma batting pads"
            price={10000}
            rating={3}
            image="https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/030665/25/fnd/IND/fmt/png/EVO-7-MD-Batting-pad"
          />
          <Product
            id="12321341"
            title="Puma basketball unisex"
            price={10000}
            rating={3}
            image="https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_600,h_600/global/083620/01/fnd/IND/fmt/png/PUMA-Indoor-Unisex-Basketball-Shoes"
          />
        </div>
        <div className="home__row">
          <Product
